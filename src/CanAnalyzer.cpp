...
:	Analyzer2(),  
	mSettings( new CanAnalyzerSettings() ),
...
U32 CanAnalyzer::GenerateSimulationData( U64 minimum_sample_index, U32 device_sample_rate, SimulationChannelDescriptor** simulation_channels )
{
